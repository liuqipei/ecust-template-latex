...
%%使用以下格式的双语caption，为加粗宋体中文caption
%\mycaption{arg1}{arg2}{arg3}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=.6\linewidth]{wedding.jpg}
...
\begin{figure}[htbp]
  ...
  \begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=.9\linewidth]{lang.jpg}
    \bicaption[fig:lang]{梦幻城堡近景}{梦幻城堡近景}{Fig.}{Fantasy castle}
  \end{minipage}
  \begin{minipage}{0.4\linewidth}
    \centering
    \includegraphics[width=.9\linewidth]{niang.jpg}
    \bicaption[fig:niang]{梦幻城堡远景}{梦幻城堡远景}{Fig.}{Fantasy castle}
  \end{minipage}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \subfigure[Castle A]{\subfigure[城堡A]{\includegraphics[height=.5\linewidth]{building1.jpg}}}
    \hspace{20pt}
    \subfigure{\label{{fig:1b}}}\addtocounter{subfigure}{-2}
    \subfigure[Castle B]{\subfigure[城堡B]{\includegraphics[height=.5\linewidth]{building2.jpg}}}
    \bicaption[fig:judy]{城堡}{城堡}{Fig.}{Fantasy castles of Tiantian}
\end{figure}
...
\begin{lstlisting}
  \begin{figure}[htbp]
 	\centering
 	\subfigure{\label{{fig:1a}}}\addtocounter{subfigure}{-2}
 	\subfigure[Castle A]{\subfigure[城堡A]{\includegraphics[height=.5\linewidth]
 			{building1.jpg}}}
 	\hspace{20pt}
 	\subfigure{\label{{fig:1b}}}\addtocounter{subfigure}{-2}
 	\subfigure[Castle B]{\subfigure[城堡B]{\includegraphics[height=.5\linewidth]
 			{building2.jpg}}}
 	\bicaption[fig:judy]{城堡}{城堡}{Fig.}{Fantasy castles of Tiantian}
  \end{figure}
\end{lstlisting}
...
下面这张图片\ref{fig:TikZ}是用TikZ宏包进行绘制的图形：
\begin{figure}[htbp]
    \centering
