...
%    Neptune.}
	\mycaption{fig:sun}{最左侧是太阳，向右依序为水星、金星、地球、火星、
		木星、土星、天王星与海王星}{Outward from the Sun, the planets
		are Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus and
		Neptune.}
\end{figure}

\begin{table}[htbp]
  \bicaption[tab:xingxing]{行星数据表1}{\textbf{行星数据表}}{Table}{Planet}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{cccc}
...
\begin{lstlisting}
  \begin{table}[htbp]
    \bicaption[tab:xingxing]{行星数据表1}{行星数据表}{Table}{Planet}
    \centering
    \vspace{0.2cm}
    \zhongwu
    \begin{tabular}{cccc}
...
\begin{table}[htbp]
  \bicaption[tab:linux]{不同操作系统下的\LaTeX{}}{ 不同操作系统下的\LaTeX{} }{Table}{OS with \LaTeX{}}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{ccc}
...
\begin{table}[htbp]
  \bicaption[tab:unix]{不同操作系统下的\LaTeX{}}{ 不同操作系统下的\LaTeX{} }{Table}{OS with \LaTeX{}}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{ccc}
...
\begin{table}[htbp]
  \centering
  \bicaption[tab:wall]{墙上的44句话}{墙上的44句话}{Table}{Mikko Kuorinki}
  \vspace{0.2cm}
  \zhongwu
...
\begin{lstlisting}
  \begin{table}[htbp]
    \centering
    \bicaption[tab:figure]{墙上的44句话}{墙上的44句话}{Table}{Mikko Kuorinki}
    \vspace{0.2cm}
    \zhongwu
    \begin{tabularx}{0.8\textwidth{}}{lX}
      \toprule
...
\begin{table}[htbp]
  \bicaption[tab:diagbox]{斜线表头}{斜线表头}{Table}{Diagbox}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{|l|ccc|}
...
\begin{table}[htbp]
  \bicaption[tab:xiexian]{斜线表头}{斜线表头}{Table}{Diagbox}
  \centering
  \vspace{0.2cm}
  \zhongwu
  \begin{tabular}{|l|ccc|}
...
\begin{figure}[htbp]
\centering
\includegraphics[width = 0.6\textwidth]{building3}
\mycaption{list}{罗列环境参数示意图}{Schematic diagram of list environments}
%\bicaption[list]{}{罗列环境参数示意图}{Fig.$\!$}{Schematic diagram of list environments}
\vspace{-1em}
\end{figure}
